...
<body>
    ...
    <div class="container">
        ...
        <form action="../../serverSite/registrationSubmit.php" method="POST" id="registrationForm">
            ...
            <button type="submit" class="btn btn-outline-success btn-block text-uppercase txt" onclick="return registrationValidation()">Register</button>
        </form><br>
        <div class="row justify-content-center d-flex">
            <p>I have an account?</p>
            <a class="signin-end-text" href="login.php">Login now</a>
        </div>
    </div>
